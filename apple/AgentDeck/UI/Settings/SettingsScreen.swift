...
struct SettingsScreen: View {
    ...
    nonisolated static func extractGatewayToken(from json: [String: Any]) -> String? {
        // Delegates to the SSOT parser on OpenClawGatewayTokenStore so the
        // Settings UI, the daemon adapter's bookmark auto-refresh, and the
        // XCTest suite all share one implementation. This symbol is retained
        // because OpenClawTokenExtractTests references it directly.
        OpenClawGatewayTokenStore.extractToken(from: json)
    }
