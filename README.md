...
| **Apple App Store** — macOS + iPhone/iPad | `apple-v*` | [1.0.6 live](https://apps.apple.com/app/id6784822497) on both platforms — build 5101. `1.0.7` (build 5201) submitted 2026-08-19, awaiting review on both platforms |
| **Elgato Marketplace** — Stream Deck plugin | `streamdeck-v*` | [1.0.5 live](https://marketplace.elgato.com/product/agentdeck-dce3806b-176e-40f2-be7d-e029bec0f464) (published 2026-08-10); `1.0.6` submitted 2026-08-19, pending review |
...
| **Google Play** — Android AAB | `android-v*` | [1.0.9 live](https://play.google.com/store/apps/details?id=dev.agentdeck) (versionCode 11, updated 2026-08-15); `1.0.10` (versionCode 12) submitted 2026-08-19, in review. Listing copy, assets and the console runbook are in [marketplace/play/](marketplace/play/LISTING.md) |
